...
/**
 * This class is a simple time tracker. 
 * It holds a time period and the duration of it in a form of days and hours.
 * 
...
public class Timetracker {
	...
	/**
	 * Updates the EndDate according to the duration
	 * by using the duration in days to calculate the new EndDate
	 */
	...
	/**
	 * sets the duration *in days* to the new duration *in days*, 
	 * updates the duration in hours accordingly and shifts the time period
	...
	/**
	 * sets the duration in hours to the new duration in hours, 
	 * updates the duration in days and shifts the time period
	 * @param duration_in_hours
	 */
	...
	/**
	 * sets the start date
	 * If the end date is already set, then there are 2 Options:
	 * 		1. End date shifts according to the duration.
	 * 		2. The duration gets adjusted according to the difference between start and end date
	 * 		TODO: decide what you want, maybe do both and add a option in settings
	 * @param startDate
	 */
	...
	/**
	 * sets the end Date
	 * Now the duration should be adjusted to the difference between the start and end date
	 * 
	 * @param endDate
	 */
